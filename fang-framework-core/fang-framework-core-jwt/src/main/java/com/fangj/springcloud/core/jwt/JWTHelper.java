...
import com.fangj.springcloud.core.commons.context.CommonConstants;
import com.fangj.springcloud.core.commons.exception.core.ExceptionCode;
import com.fangj.springcloud.core.commons.utils.StringHelper;
import com.fangj.springcloud.core.exception.BizException;

/**
 * jsonwebtoken 解析和生成jwt
 */
        ...
        try {
            String compactJws =
                    ...
                    Jwts.builder()
                            ...
                            //这个是全部设置完成后拼成jwt串的方法
                            .compact();
            return new TokenVo(compactJws, expire,jwtInfo.getTokenType(),jwtInfo.getScope());
